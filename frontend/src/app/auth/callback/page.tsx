  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      if (token) {
        ...
        console.log('Auth Callback: Token saved to localStorage. Refreshing user...');
        try {
          await refreshUser();
          console.log('Auth Callback: User refreshed. Redirecting to dashboard...');
    ...
    >
      ...
      >
        ...
        <Box sx={{ textAlign: 'center' }}>
          <Typography variant="h6" sx={{ color: 'white', fontWeight: 'bold', mb: 1, fontFamily: 'var(--font-mountains)' }}>
