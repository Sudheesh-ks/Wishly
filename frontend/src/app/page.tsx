...
export default function Home() {
  ...
  return (
    <Box sx={{ position: 'relative', overflowX: 'hidden', minHeight: '100vh' }}>
      ...
      <Container maxWidth="lg" sx={{ height: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        {/* Hero Section */}
        <Box
          ...
          sx={{ textAlign: 'center' }}
        >
          <Typography variant="h1" sx={{ color: 'white', mb: 2, textShadow: '0 0 20px rgba(255,255,255,0.5)', fontSize: { xs: '4rem', md: '6rem' } }}>
            Welcome to the North Pole
          </Typography>
          <Typography variant="h5" sx={{ color: '#F8B229', mb: 6, fontFamily: 'var(--font-inter)' }}>
